...
with col1:
    ...
    <div class="energy-container"><span class="energy-label" style="color:#4A90E2;">Master</span>
        <div style="display:flex; align-items:center;"><div class="bar-outline"><div class="bar-fill" style="width:54%; background:#4A90E2;"></div></div><span class="percent-text">54%</span></div>
    </div>
    <div class="energy-container"><span class="energy-label" style="color:#FF5252;">Slave</span>
        <div style="display:flex; align-items:center;"><div class="bar-outline" style="border-color:#FF5252;"><div class="bar-fill" style="width:35%; background:#FF5252;"></div></div><span class="percent-text" style="color:#FF5252;">35%</span></div>
    </div>
    ''', unsafe_allow_html=True)
